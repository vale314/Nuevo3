...
import SignUpForm from '../../../componets/Admin/Empresas/Views.jsx';
...
class RegistroEmp extends React.Component {
   ...
   */
   processForm(event) {
     ...
     const formData = `name=${name}&id=${this.state.id}&repLegal=${repLegal}&formato=${formato}&telefono=${telefono}&celular=${celular}&rubro=${rubro}&tamaño=${tamaño}&numT=${numT}&calle=${calle}&domN=${domN}&colonia=${colonia}&municipio=${municipio}&estado=${estado}&cp=${cp}&depDA=${depDA}&cargo=${cargo}&email=${email}`;
